...
void _productSerialize(
  ...
  writer.writeDouble(offsets[6], object.profitMargin);
...
Product _productDeserialize(
  ...
  final object = Product(
    ...
    stockQuantity: reader.readDouble(offsets[8]),
    unitPrice: reader.readDouble(offsets[9]),
  );
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> buyingPriceEqualTo(
    double value, {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> buyingPriceGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> buyingPriceLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> buyingPriceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  QueryBuilder<Product, Product, QAfterSortBy> sortByBuyingPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'buyingPrice', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByBuyingPriceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByBuyingPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'buyingPrice', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByBuyingPriceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'buyingPrice', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByBuyingPrice() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, double, QQueryOperations> buyingPriceProperty() {
    return QueryBuilder.apply(this, (query) {
